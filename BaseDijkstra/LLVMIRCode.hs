...
inputFuncs = unlines $ [
  ...
  "  %4 = call i32 (i8*, ...)* @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8]* @.floatfmt, i32 0, i32 0), double* %var)",
  "  %5 = load double* %var, align 8",
  "  ret double %5",
  "}",
  "",
  ...
  "  %2 = load i8** %1, align 8",
  "  %3 = call i32 (i8*, ...)* @printf(i8* %2)",
  "  %4 = call i32 (i8*, ...)* @__isoc99_scanf(i8* getelementptr inbounds ([4 x i8]* @.intfmt, i32 0, i32 0), i64* %var)",
  "  %5 = load i64* %var, align 8",
  "  ret i64 %5",
  "}",
  "",
